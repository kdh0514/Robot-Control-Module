...
ros::Publisher pub_range1( "range_data_S1", &range_msg1);
ros::Publisher pub_range2("range_data_S2", &range_msg2);
ros::Publisher pub_range3( "range_data_S3", &range_msg3);
ros::Publisher pub_range4("range_data_S4", &range_msg4);
...
float getRange(int pin_num){
   ...
   // if(sample < 10)
    ...
    return (sample - 2); //convert to meters
    //return sample;
}
